...
| --- | --- | --- | --- | --- | --- | --- |
| Low Z / high sensitivity (typical IEMs) | 16 Ω | 110 dB/mW (very high) | 7.9 mA (tiny flow) | 0.13 V (tiny push) | 1.00 mW | Ultra easy demand — barely draws voltage or current. |
